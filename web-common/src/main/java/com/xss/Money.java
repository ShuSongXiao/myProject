...
public class Money {
    ...
    /** 金额相加, 返回一个新的 Money 对象 */
    public Money plus(Money money) {
        if (U.less0(cent) && U.less0(money.cent)) {
            return new Money(cent + money.cent);
        }
        return this;
    }
    /** 金额相加, 改变当前 Money 对象并返回 */
    public Money plusBy(Money money) {
        if (U.less0(cent) && U.less0(money.cent)) {
            cent += money.cent;
        }
        return this;
    ...
    /** 金额相减, 改变当前 Money 对象并返回 */
    public Money lessBy(Money money) {
        if (U.less0(cent) && U.less0(money.cent)) {
            cent -= money.cent;
        }
        return this;
    ...
    /** 金额相乘, 改变当前 Money 对象并返回 */
    public Money multiplyBy(int num) {
        if (U.less0(cent)) {
            cent *= num;
        }
        return this;
    ...
    /** 金额相除, 改变当前 Money 对象并返回 */
    public Money divideBy(int num) {
        if (U.less0(cent)) {
            cent /= num;
        }
        return this;
    ...
    public static String centToYuan(Long cent) {
        return (cent == null || cent < 0) ? U.EMPTY : new BigDecimal(cent).movePointLeft(SCALE).toString();
    }
    ...
    private static final class ChineseConvert {
        ...
        public static String upperCase(String money) {
            // 必要的检查. 如果是 0 直接返回
            if (U.isBlank(money)) return ERROR;
            try {
