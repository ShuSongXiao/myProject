...
public class HttpClientUtils {
    ...
    public static String sendGet(String url, Map<String, String> headers, Map<String, String> params) {
        ...
        LogUtil.ROOT_LOG.info("[url:" + url + ",method:" + GET_METHOD + "]");
        HttpGet httpGet = new HttpGet(url);
        /**
         * 设置头部
         */
        LogUtil.ROOT_LOG.info("Header\n");
        if (headers != null && headers.size() > 0) {
            for (Map.Entry<String, String> header : headers.entrySet()) {
                httpGet.addHeader(header.getKey(), header.getValue());
                LogUtil.ROOT_LOG.info(header.getKey() + " : " + header.getValue());
            }
        }
        ...
        try {
            ...
            LogUtil.ROOT_LOG.info("网络请求出错，请检查原因");
        } finally {
            // 关闭资源
            try {
                if (response != null) {
                ...
                LogUtil.ROOT_LOG.info("网络关闭错误错，请检查原因");
            }
        }
        return result;
    }
    ...
    public static String senPostJson(String url, String json, Map<String, String> headers) {
        ...
        LogUtil.ROOT_LOG.info("[url: " + url + ",method: " + POST_METHOD + ", json: " + json + "]");
        /**
         * 设置头部
         */
        if (headers != null && headers.size() > 0) {
    ...
    /*作者：Kevin_ZGJ
    链接：http://www.jianshu.com/p/5eedb921c4d9
    來源：简书
